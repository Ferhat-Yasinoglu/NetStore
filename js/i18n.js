...
const I18N = {
  ...
  c_trend:         { tr:'Eğilim', en:'Trend', fa:'روند' },
  greet_morning:   { tr:'Günaydın', en:'Good morning', fa:'صبح بخیر' },
  greet_day:       { tr:'İyi günler', en:'Good afternoon', fa:'روز بخیر' },
  greet_evening:   { tr:'İyi akşamlar', en:'Good evening', fa:'عصر بخیر' },
  greet_night:     { tr:'İyi geceler', en:'Good night', fa:'شب بخیر' },
  hero_today:      { tr:'Bugün {n} satış · {a} tahsilat', en:'{n} sales today · {a} collected', fa:'امروز {n} فروش · {a} دریافتی' },
  hero_quiet:      { tr:'Bugün henüz hareket yok — iyi satışlar!', en:'No activity yet today — good luck with sales!', fa:'امروز هنوز حرکتی نیست — فروش خوبی داشته باشید!' },
  hero_open:       { tr:'{n} açık fatura', en:'{n} open invoices', fa:'{n} فاکتور باز' },
  hero_low:        { tr:'{n} ürün kritik stokta', en:'{n} products at critical stock', fa:'{n} جنس در موجودی بحرانی' },
  ...
  vf_ok_warranty:  { tr:'Garanti belgesi doğrulandı — aşağıdaki satışa ait.', en:'Warranty certificate verified — it belongs to the sale below.', fa:'گرنتی‌نامه تأیید شد — مربوط به فروش زیر است.' },

  /* garanti belgesi (js/invoice.js → warrantyDoc) */
  wr_title:        { tr:'GARANTİ BELGESİ', en:'WARRANTY CERTIFICATE', fa:'گرنتی‌نامه' },
  wr_no:           { tr:'Belge No', en:'Certificate No', fa:'شماره سند' },
  wr_start:        { tr:'Başlangıç', en:'Start', fa:'شروع' },
  wr_end:          { tr:'Garanti Bitişi', en:'Warranty Ends', fa:'پایان گرنتی' },
  wr_device:       { tr:'Cihaz', en:'Device', fa:'دستگاه' },
  wr_serial:       { tr:'Seri No / IMEI', en:'Serial No / IMEI', fa:'شماره سریال / IMEI' },
  wr_period:       { tr:'Süre', en:'Period', fa:'مدت' },
  wr_months:       { tr:'{n} ay', en:'{n} months', fa:'{n} ماه' },
  wr_no_serial:    { tr:'girilmedi', en:'not entered', fa:'وارد نشده' },
  wr_valid:        { tr:'GARANTİ GEÇERLİ', en:'UNDER WARRANTY', fa:'دارای گرنتی' },
  wr_expired:      { tr:'GARANTİ BİTTİ', en:'WARRANTY ENDED', fa:'گرنتی تمام شد' },
  wr_days_left:    { tr:'{n} gün kaldı', en:'{n} days left', fa:'{n} روز مانده' },
  wr_terms:        { tr:'Garanti Şartları', en:'Warranty Terms', fa:'شرایط گرنتی' },
  wr_covered:      { tr:'Kapsam', en:'Covered', fa:'تحت پوشش' },
  wr_covered_1:    { tr:'Üretim ve montaj hatalarından doğan arızalar.', en:'Faults arising from manufacturing or assembly defects.', fa:'خرابی‌های ناشی از عیب تولید یا مونتاژ.' },
  wr_covered_2:    { tr:'Normal kullanımda kendiliğinden bozulan parçalar.', en:'Parts that fail by themselves under normal use.', fa:'قطعاتی که در استفادهٔ عادی خودبه‌خود خراب می‌شوند.' },
  wr_covered_3:    { tr:'Onarım mümkün değilse aynı model ile değişim.', en:'Replacement with the same model where repair is not possible.', fa:'تعویض با همان مدل در صورت غیرممکن بودن تعمیر.' },
  wr_excluded:     { tr:'Kapsam Dışı', en:'Not covered', fa:'خارج از پوشش' },
  wr_excluded_1:   { tr:'Düşme, kırılma, ezilme ve sıvı teması.', en:'Drops, breakage, crushing and liquid contact.', fa:'افتادن، شکستن، له‌شدگی و تماس با مایعات.' },
  wr_excluded_2:   { tr:'Yetkisiz kişilerce açılan ya da onarılan cihazlar.', en:'Devices opened or repaired by unauthorised persons.', fa:'دستگاه‌هایی که توسط افراد غیرمجاز باز یا تعمیر شده‌اند.' },
  wr_excluded_3:   { tr:'Yanlış voltaj, uygun olmayan şarj cihazı ve yazılım müdahalesi.', en:'Wrong voltage, unsuitable chargers and software tampering.', fa:'ولتاژ نادرست، شارژر نامناسب و دستکاری نرم‌افزاری.' },
  wr_excluded_4:   { tr:'Sarf parçalar: batarya ömrü, kablo, kılıf ve ekran koruyucu.', en:'Consumables: battery wear, cables, cases and screen protectors.', fa:'اقلام مصرفی: فرسودگی باتری، کیبل، کڤر و محافظ صفحه.' },
  wr_howto:        { tr:'Nasıl kullanılır', en:'How to claim', fa:'چگونه استفاده کنید' },
  wr_howto_text:   { tr:'Bu belgeyi ve faturayı cihazla birlikte dükkâna getirin. Belge üzerindeki seri numarası ile cihazdaki numara aynı olmalıdır.', en:'Bring this certificate and the invoice together with the device to the shop. The serial number on the certificate must match the one on the device.', fa:'این سند و فاکتور را همراه دستگاه به دکان بیاورید. شماره سریال روی سند باید با شمارهٔ روی دستگاه یکی باشد.' },
  wr_sign_shop:    { tr:'Satıcı Kaşe / İmza', en:'Seller Stamp / Signature', fa:'مهر و امضای فروشنده' },
  wr_sign_cust:    { tr:'Müşteri İmza', en:'Customer Signature', fa:'امضای مشتری' },
  wr_foot:         { tr:'Bu belge NetStore tarafından elektronik olarak düzenlenmiştir ve karekodu ile doğrulanabilir.', en:'This certificate was issued electronically by NetStore and can be verified with its QR code.', fa:'این سند به‌صورت الکترونیکی توسط نت‌ستور صادر شده و با کد QR آن قابل تأیید است.' },

  /* garanti: seri no girişi ve ayarlar */
  btn_warranty:    { tr:'Garanti', en:'Warranty', fa:'گرنتی' },
  wf_title:        { tr:'Garanti Belgesi', en:'Warranty Certificate', fa:'گرنتی‌نامه' },
  wf_sub:          { tr:'Cihazların seri numarasını girin; belgeye basılır. Boş bırakabilirsiniz.', en:'Enter the devices\' serial numbers; they are printed on the certificate. You may leave them blank.', fa:'شماره سریال دستگاه‌ها را وارد کنید؛ روی سند چاپ می‌شود. می‌توانید خالی بگذارید.' },
  wf_open:         { tr:'Belgeyi Aç', en:'Open Certificate', fa:'باز کردن سند' },
  wf_none:         { tr:'Bu satışta garantili ürün yok. Ürün kartından garanti süresi verebilirsiniz.', en:'No product in this sale has a warranty. You can set a warranty period on the product card.', fa:'در این فروش جنس دارای گرنتی نیست. می‌توانید از کارت جنس مدت گرنتی تعیین کنید.' },
  wf_saved:        { tr:'Seri numaraları kaydedildi.', en:'Serial numbers saved.', fa:'شماره‌های سریال ذخیره شد.' },
  s_warranty:      { tr:'Garanti', en:'Warranty', fa:'گرنتی' },
  s_warranty_sub:  { tr:'Satılan cihazların garanti süresi', en:'Warranty period for devices sold', fa:'مدت گرنتی دستگاه‌های فروخته‌شده' },
  s_warranty_def:  { tr:'Varsayılan Garanti (ay)', en:'Default Warranty (months)', fa:'گرنتی پیش‌فرض (ماه)' },
  s_warranty_hint: { tr:'Yeni ürünlerde başlangıç değeri; 0 girilirse ürün garantisiz sayılır ve belgeye yazılmaz.', en:'The starting value for new products; 0 means the product has no warranty and is left off the certificate.', fa:'مقدار اولیه برای اجناس جدید؛ ۰ یعنی جنس گرنتی ندارد و در سند نوشته نمی‌شود.' },
  fld_warranty:    { tr:'Garanti (ay)', en:'Warranty (months)', fa:'گرنتی (ماه)' },
